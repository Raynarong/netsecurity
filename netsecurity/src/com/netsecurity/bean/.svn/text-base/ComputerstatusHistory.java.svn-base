...
/**
 * ComputerstatusHistory entity. @author MyEclipse Persistence Tools
 */

public class ComputerstatusHistory implements java.io.Serializable
{
	...
	/** default constructor */
	public ComputerstatusHistory()
	{
	}

	/** minimal constructor */
	public ComputerstatusHistory(Computerinfo computerinfo)
	{
		this.computerinfo = computerinfo;
	}

	/** full constructor */
	public ComputerstatusHistory(Computerinfo computerinfo, Long upload,
