...
<form name="add" id="add" method="post" action="addLeader.action">
  <TABLE width="98%">
    <TBODY>
      <TR>
        <TD width="30">查找</TD>
        <TD colspan="3"><input name="userName" id="userName" type="text" maxlength="10" value="" />
        				<div id="snError" style="display:inline"></div>
        </TD>
        <td><input id="searchLeader" type='button'  onclick="searchName()" value="确定"></input></TD>
      </TR>
	 
	  <TR>
        <TD width="20%">请选择老师</TD>
        <TD width="20%">
            <select name="searchStr" id="userid" style="width:80%">
