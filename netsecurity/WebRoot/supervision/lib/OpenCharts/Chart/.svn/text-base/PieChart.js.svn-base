...
OpenCharts.Chart.PieChart = OpenCharts.Class(OpenCharts.Chart,{
    ...
    addEventListener:function(action,message){
		...
		/***************************************/
		me.msgObj.setAttribute("style","font-size:20px");
		/***************************************/
    ...
    renderLegend:function(){
		...
		var txtPosition = new OpenCharts.Point(me.width-10-nWidth-15,(me.height-nHeight)/2+2*charWidth+5);
        ...
        me.myContext.strokeRect(titlePosition.x - charWidth*2-15,titlePosition.y-charWidth*2,me.width-titlePosition.x+2*charWidth - 5 + 10,nItems*2*charWidth+charWidth);
        ...
        for(var i=0;i<nItems;i++)
        {
            ...
            me.myContext.strokeStyle = "#000";
            me.myContext.lineWidth = 1;
            me.myContext.fillRect(titlePosition.x - charWidth-5-15,titlePosition.y-charWidth,12,12);
            me.myContext.strokeRect(titlePosition.x - charWidth-5-15,titlePosition.y-charWidth,12,12);

            strTitle = me.itemArray[0][i].strCaption;			
            OpenCharts.RenderEnginer.renderText(me.myContext,strTitle,textstyle,txtPosition);
            titlePosition.y += 2*charWidth;
			txtPosition.y += 2*charWidth;
        }
    },
