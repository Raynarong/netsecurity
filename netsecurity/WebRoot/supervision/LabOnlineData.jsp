...
$(function(){
    ...
    $grid.datagrid({
	   ...
	   columns: [[
                /*{checkbox: true},*/
                {field: 'labName', title: '实验室',width:wid * 0.2,formatter:function(value,row,index){
					return '<a href="showUsersOnLinePage.action?labId='+row.labId+'">'+value+'</a>'+'<a href="#" onclick="openLineChart1(\'dlg\', \''+value+'实验室行为统计\', \'dlg-toolbar\', \'#00C000\', \'canvas\','+row.labId+');"><img title="电脑状态线图" width="16" height="16" style="margin-left:5px;" border="0" src="enterUploadPage_files/line.png"></a>';}, sortable: true},
				{field: 'labId',hidden:true},
				{field: 'totalNum', title: '总学生',formatter:function(value){
					return '<span class="blue">'+value+'</span>';},width:wid * 0.2},
				{field: 'onlineNum', title: '实时在线学生',formatter:function(value){
					return '<span class="green2">'+value+'</span>';},width:wid * 0.2},
				{field: 'offlineNum', title: '离线学生',formatter:function(value){
