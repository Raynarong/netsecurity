...
$(function(){
    ...
    $grid.datagrid({
		...
		fitColumns: true,
        idField: 'tools',
        url: '/commonUser/showCommonUserOnlineData.action',
        pagination: true,
		pageSize: 10,
		rownumbers:true,
		singleSelect:true,
	   ...
	   columns: [[
				...
				{field: 'username',title:'姓名',formatter:function(value,row,index){
					return '<a href="/commonUser/showComputerOnLinePage.action?userId='+row.userid+'">'+value+'</a>'+'<a href="#" onclick="openLineChart1(\'dlg\', \''+value+'电脑行为统计\', \'dlg-toolbar\', \'#00C000\', \'canvas\','+row.userid+');"><img title="电脑状态线图" width="16" height="16" style="margin-left:5px;" border="0" src="enterUploadPage_files/line.png"></a>';
				},width:wid*0.2},
...
function openLineChart1(id, title, toolbar_id, line_color, canvas,userid)
{
	...
	var unit=$('#unit').val();
	var url='/commonUser/getUserStatusTrendData.action';
	var parameters={
		'userId':userid,
		'timeType':timeType,
