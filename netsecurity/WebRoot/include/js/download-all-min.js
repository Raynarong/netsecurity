...
var DOWNLOAD_URL = ["http://202.197.61.249:8080/NetsecuratyInstall.zip", "http://bcscdn.baidu.com/netdisk/BaiduYun_3.6.0.apk", "http://itunes.apple.com/cn/app/bai-du-wang-pan/id547166701?mt=8", "http://itunes.apple.com/cn/app/bai-du-yun-hd/id554602005?mt=8", "http://www.windowsphone.com/zh-cn/store/app/%E7%99%BE%E5%BA%A6%E4%BA%91/59bf5640-85ae-4a6e-84f1-a61c074e667c", "http://bcscdn.baidu.com/netdisk/BaiduYun_3.5.0.exe", "http://bcscdn.baidu.com/netdisk/BaiduYun_2.0.0.dmg"];
var DOWNLOAD_URL_LOGIN = ["http://bcscdn.baidu.com/netdisk/BaiduYun_3.6.0.apk", "http://itunes.apple.com/cn/app/bai-du-wang-pan/id547166701?mt=8", "http://itunes.apple.com/cn/app/bai-du-yun-hd/id554602005?mt=8", "http://www.windowsphone.com/zh-cn/store/app/%E7%99%BE%E5%BA%A6%E4%BA%91/59bf5640-85ae-4a6e-84f1-a61c074e667c", "http://bcscdn.baidu.com/netdisk/BaiduYun_3.5.0.exe", ];
var DOWNLOAD_DES = [["大小：957KB", "版本：PC版 V2.0.0", "适应系统：windows XP/vista/win7/win8", "更新时间：2013-02-25"], ["大小：1.6M 版本：Linux Ubuntu 12.10版", "适应系统：Linux2.2、Linux2.3<br/><i>Linux4.0</i>", "更新时间：2012/6/13"], ["大小：2.5M 版本：Iphone版2.0.0", "适应系统：IOS 4.0 及以上<br/><i>（需越狱后才能安装）</i>", "更新时间：2012/6/7"], ["大小：5.6M 版本：iPad版 V2.0.0", "适应系统：IOS 4.3 及以上<br/><i>（需越狱后才能安装）</i>", "更新时间：2012/8/15"], ["大小：5M 版本：WinPhone版v2.0.0", "适应系统：Windows Phone 7.5 及以上", "更新时间：2013/03/29"], ["大小：5.51MB 版本：Window版3.0.0", "适应系统：windows XP/vista/win7", "更新时间：2012/6/19"], ["大小：5M 版本：Mac版 V2.0.0", "适应系统：Mac OS 10.7 及以上", "更新时间：2013/04/25"]];
var DOWNLOAD_UPDATE = [false, false, false, false, false, false];
var DOWNLOAD_LIST = ["windows", "Linux", "iphone", "ipad", "wphone", "tongbupan"];
var CO_APK = [{
    src: "http://s1.pan.bdstatic.com/static/images/plug/fex48.png?r=201405080428",
    width: "56px",
    title: "内网安全客户端下载",
...
{
    src: "http://s1.pan.bdstatic.com/static/images/plug/icon.png?r=201405080428",
    title: "内网安全客户端下载",
    width: "56px",
    desc: "最佳Linux资源管理文件同步解决方案。",
    level: 5,
    url: "http://www.xageek.com/software/FileExpertLatest.apk"
},
{
    src: "http://s1.pan.bdstatic.com/static/images/plug/icon72.png?r=201405080428",
    width: "54px",
    title: "内网安全客户端下载",
    ...
    var a = function() {
        ...
        this._mTabClickListener = function() {
            var c = parseInt(this.getAttribute("_idx"));
            b.setSelected(c);
            return false
        }
    };
    a.prototype = {
        setSelected: function(c, b) {
            if (c == this._mSelectedIndex) {
                return
            }
            if (this.onInterfereTabChange(this._mSelectedIndex, c)) {
                return
            }
            this._uiSetSelected(this._mSelectedIndex, false);
            this._uiSetSelected(c, true);
            this.onTabChange(this._mSelectedIndex, c);
            this._mSelectedIndex = c
        },
        _uiSetSelected: function(d, c) {
            var b = this._mTabIndicators[d];
            var e = this._mTabContents[d];
            if (c) {
                if (b) {
                    $(b).addClass(this._mOnClass)
                }
                if (e) {
                    $(e).css("display", "block")
                }
        ...
        addTab: function(b, c) {
            b.setAttribute("_idx", this._mTabIndicators.length);
            this._mTabIndicators.push(b);
            this._mTabContents.push(c);
            b.onclick = this._mTabClickListener
        },
        ...
        onTabChange: function(c, b) {},
        onInterfereTabChange: function(c, b) {
            return false
        }
    };
    window.SimpleTabHost = a
})();
...
$(window).ready(function() {
    var a = window.ClientDownLoad = {};
    a.isData = false;
    a.vcode_str = null;
    a.SMS_PATTERN = /^(?:\+86)*(1[3458]{1}[0-9]{1}\d{8})$/gi;
    a.GET_VERIFYCODE_URL = "/inbox/object/getvcode";
    a.SEND_MESSAGE_URL = "/inbox/object/sendmessage";
    a.setCookie = function(c, d, b) {
        var e = new Date();
        ...
        if ((h >= 5.5) && (document.body.filters)) {
            for (var d = 0; d < document.images.length; d++) {
                ...
                if (k.substring(k.length - 3, k.length) == "PNG") {
                    ...
                    var b = "<span " + f + l + c + ' style="float:left; width:' + e.width + "px; height:" + e.height + "px;" + i + ";filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + e.src + "', sizingMethod='scale');\"></span>";
                    e.outerHTML = b;
                    d = d - 1
                }
            }
        ...
        $.ajax({
            ...
            success: function(f, d) {
                ...
                if (m != null && m.errorno == 0) {
                    if (m.guanjia) {
                        var c = m.guanjia;
                        //DOWNLOAD_DES[0] = ["大小：" + c.size, "版本：" + c.version, "适应系统：" + c.system, "更新时间：" + c.publish.split(" ")[0]];
                        //DOWNLOAD_URL[0] = "http://bcscdn.baidu.com/netdisk/BaiduYunGuanjia_" + c.version.match(/V(.+$)/)[1] + ".exe"
                    }
                    if (m.android) {
                        var j = m.android;
                        DOWNLOAD_DES[1] = ["大小：" + j.size, "版本：" + j.version, "适应系统：" + j.system, "更新时间：" + j.publish.split(" ")[0]];
                       // DOWNLOAD_UPDATE[1] = [(new Date().getTime() - new Date(j.publish.replace(/-/g, "/")).getTime()) < 259200000 ? true: false, new Date(j.publish.replace(/-/g, "/")).getTime()];
                       // DOWNLOAD_URL[1] = "http://bcscdn.baidu.com/netdisk/BaiduYun_" + j.version.match(/V(.+$)/)[1] + ".apk"
                    }
                    if (m.iphone) {
                        var h = a.iData = m.iphone;
                       // DOWNLOAD_DES[2] = ["大小：" + h.size, "版本：" + h.version, "适应系统：" + h.system, "更新时间：" + h.publish.split(" ")[0]];
                       // DOWNLOAD_UPDATE[2] = [((new Date().getTime() - new Date(h.publish.replace(/-/g, "/")).getTime()) < 259200000) ? true: false, new Date(h.publish.replace(/-/g, "/")).getTime()]
                    }
                    if (m.ipad) {
                        var i = m.ipad;
                       // DOWNLOAD_DES[3] = ["大小：" + i.size, "版本：" + i.version, "适应系统：" + i.system, "更新时间：" + i.publish.split(" ")[0]];
                       // DOWNLOAD_UPDATE[3] = [(new Date().getTime() - new Date(i.publish.replace(/-/g, "/")).getTime()) < 259200000 ? true: false, new Date(i.publish.replace(/-/g, "/")).getTime()]
                    }
                    if (m.winphone) {
                        var l = m.winphone;
                       // DOWNLOAD_DES[4] = ["大小：" + l.size, "版本：" + l.version, "适应系统：" + l.system, "更新时间：" + l.publish.split(" ")[0]];
                       // DOWNLOAD_UPDATE[4] = [(new Date().getTime() - new Date(l.publish.replace(/-/g, "/")).getTime()) < 259200000 ? true: false, new Date(l.publish.replace(/-/g, "/")).getTime()]
                    }
                    if (m.windows) {
                        var k = m.windows;
                       // DOWNLOAD_DES[5] = ["大小：" + k.size, "版本：" + k.version.match(/V(.+$)/)[0], "适应系统：" + k.system, "更新时间：" + k.publish.split(" ")[0]];
                      //  DOWNLOAD_UPDATE[5] = [(new Date().getTime() - new Date(k.publish.replace(/-/g, "/")).getTime()) < 259200000 ? true: false, new Date(k.publish.replace(/-/g, "/")).getTime()];
                      //  DOWNLOAD_URL[5] = "http://bcscdn.baidu.com/netdisk/BaiduYun_" + k.version.match(/V(.+$)/)[1] + ".exe"
                    }
                    if (m.mac) {
                        var b = m.mac;
                      //  DOWNLOAD_DES[6] = ["大小：" + b.size, "版本：" + b.version, "适应系统：" + b.system, "更新时间：" + b.publish.split(" ")[0]];
                      //  DOWNLOAD_UPDATE[6] = [(new Date().getTime() - new Date(b.publish.replace(/-/g, "/")).getTime()) < 259200000 ? true: false, new Date(b.publish.replace(/-/g, "/")).getTime()];
                      //  DOWNLOAD_URL[6] = "http://bcscdn.baidu.com/netdisk/BaiduYun_" + b.version.match(/V(.+$)/)[1] + ".dmg"
                    }
                    DOWNLOAD_UPDATE[5] = [DOWNLOAD_UPDATE[5][0] || DOWNLOAD_UPDATE[6][0], DOWNLOAD_UPDATE[5][1] + DOWNLOAD_UPDATE[6][1]]
                }
                a.applyDownloadSetting()
            },
            error: function() {
                a.applyDownloadSetting()
            }
    ...
    a.fillInfo = function() {
        $(".content-info div").each(function(b) {
            if (DOWNLOAD_URL[b] != "") {
                $(this).find("a").eq(0).attr("href", DOWNLOAD_URL[b]);
                $(this).find("p").each(function(c) {
                    this.innerHTML = DOWNLOAD_DES[b][c]
                })
            } else {
                $(this).find("p").eq(0).html(DOWNLOAD_DES[b][0])
            }
        })
    };
    a.checkUpdate = function() {
        $("#tab-download a").each(function(c) {
            var b = a.getCookie(DOWNLOAD_LIST[c]);
            if (DOWNLOAD_UPDATE[c][0] && b != DOWNLOAD_UPDATE[c][1]) {
                $(this).append("<em></em>")
            }
        })
    };
    a.applyDownloadSetting = function() {
       // a.fillInfo();
       // a.checkUpdate()
    };
    a.tabChange = function() {
        var c = new window.SimpleTabHost();
        var h = $("#tab-download li");
        var g = $("#download-info .content");
        var f = true;
        var j = {
            win: 0,
            android: 1,
        ...
        c.onTabChange = function(k, i) {
            if (f) {
                f = false;
                return
            }
            if ($("#tab-download a").eq(i).find("em") != []) {
                a.setCookie(DOWNLOAD_LIST[i], DOWNLOAD_UPDATE[i][1], 30);
                $("#tab-download a").eq(i).find("em").remove()
            }
        };
        var d = location.href.indexOf("#");
        if (d != -1) {
            if (location.href.substring(d + 1) != "undefined") {
                c.setSelected(j[location.href.substring(d + 1)])
            } else {
                c.setSelected(0)
            }
        } else {
    ...
    a.verifyCodeLoad = function() {
        $.ajax({
            url: a.GET_VERIFYCODE_URL,
            dataType: "json",
            timeout: 3 * 1000,
            success: function(b) {
                $("#cap-img").attr("src", b.imgurl);
                a.vcode_str = b.vcode_str
            },
            error: function() {
                $("#cap-img").attr("alt", "验证码获取失败")
            }
        })
    };
    a.init = function() {
        ...
        $(".phoneNumber").focus(function() {
            if ($(".phoneNumber").val() == "请输入手机号") {
                $(".phoneNumber").attr("value", "")
            }
            $(".phoneNumber").css("color", "#333")
        }).blur(function() {
            if ($(".phoneNumber").val() == "") {
                $(".phoneNumber").attr("value", "请输入手机号");
                $(".phoneNumber").css("color", "gray")
            }
        });
        $(".verifyCode").focus(function() {
            ...
            if ($(".verifyCode").val() == "") {
                $(".verifyCode").attr("value", "验证码");
                $(".verifyCode").css("color", "gray")
            }
        });
        $("#send_submit").bind("click", a.dataValidation)
    };
    a.countDown = function(c) {
        var e = $("#send_submit b");
        $("#send_submit").addClass("disabled");
        $("#send_submit").addClass("waitminute");
        var d = function() {
            e.html(c--+"秒后可再发送")
        };
        $(".error-text").css("color", "#000");
        $(".error-text").show().text("短信已发送");
        var b = function() {
            if (c < 0) {
                clearInterval(time);
                clearInterval(checktime);
                $("#send_submit b").html("发送短信");
                $("#send_submit").removeClass("disabled");
                $("#send_submit").removeClass("waitminute");
                $(".error-text").hide().text("");
                $(".error-text").css("color", "#f00");
                $(".phoneNumber").attr("value", "请输入手机号");
                $(".phoneNumber").css("color", "gray");
                $(".verifyCode").attr("value", "验证码");
                $(".verifyCode").css("color", "gray");
        ...
        checktime = setInterval(b, 500);
        time = setInterval(d, 1000)
    };
    a.verifyLength = function(d, c) {
        var b = d.replace(/[^\x00-\xff]/g, "**");
        if (c == b.length) {
            return true
        } else {
            return false
    ...
    a.sendMessage = function() {
        ...
        if (b == "" || b == "验证码") {
            $(".error-text").show().text("请输入验证码");
            a.verifyCodeLoad()
        } else {
            if (!a.verifyLength(b, 4)) {
                $(".error-text").show().text("验证码长度输入有误");
                a.verifyCodeLoad()
            } else {
                $(".error-text").hide().text("");
                $.ajax({
                    url: a.SEND_MESSAGE_URL + "&t=" + new Date().getTime(),
                    dataType: "json",
                    type: "get",
                    data: {
                    ...
                    success: function(c) {
                        if (c.errno != "undefined" && c.errno == 0) {
                            a.countDown(59)
                        } else {
                            $(".error-text").show().text("验证码错误，请重新输入");
                            $(".verifyCode").attr("value", "").focus();
                            a.verifyCodeLoad()
                        }
                    }
                })
    ...
    a.dataValidation = function(d) {
        if ($("#send_submit").hasClass("disabled")) {} else {
            var c = $(".phoneNumber").val();
            var b = $(".verifyCode").val();
            if (c != "" && c != "输入手机号" && c.match(a.SMS_PATTERN)) {
                a.sendMessage()
            } else {
                if (c == "" || c == "请输入手机号") {
                    $(".error-text").show().text("请输入手机号");
                    $(".phoneNumber").focus()
                } else {
                    if (!c.match(a.SMS_PATTERN)) {
                        $(".error-text").show().text("手机号码错误");
                        $(".phoneNumber").focus()
                    }
                }
            }
    ...
    a.bindClientDownLoadLog = function() {
        $(".content-info a").mousedown(function() {
            var b = "",
            c = "infocenter";
            if ($(this).hasClass("clint-guanjia")) {
                b = "guanjia"
            } else {
                if ($(this).hasClass("clint-android")) {
                    b = "android"
                } else {
                    if ($(this).hasClass("clint-iphone")) {
                        b = "iphone"
                    } else {
                        if ($(this).hasClass("clint-ipad")) {
                            b = "ipad"
                        } else {
                            if ($(this).hasClass("clint-wphone")) {
                                b = "winphone"
                            } else {
                                if ($(this).hasClass("clint-windows")) {
                                    b = "win"
                                } else {
                                    if ($(this).hasClass("clint-mac")) {
                                        b = "mac"
                                    }
                                }
                            }
            ...
            setTimeout(function() {
                var d = new Image();
                d.src = "/api/analytics?_lsix=1&page=1&clienttype=0&type=downloadclient&ttype=" + b + "&pos=" + c
            },
            500);
            return true
        })
    ...
    a.isMacOs = function() {
        ...
        if (b.indexOf("Mac") != -1 && location.hash == "") {
            location.href = location.href + "#pan"
        }
    };
    a.main = function() {
        a.isMacOs();
...
$(window).ready(function() {
    var a = {
        imgLog: function(f, h) {
            for (var g in h) {
                f += (f.match(/\?/) ? "&": "?") + encodeURIComponent(g) + "=" + encodeURIComponent("" + h[g])
            }
            f += (f.match(/\?/) ? "&": "?") + "t=" + ( + new Date());
            var e = new Image();
            e.onload = function() {};
            e.src = f
        },
        whatPage: function(i) {
            ...
            var e = /^https?\:\/\/pan\.baidu\.com\/?(\#.*)?$/;
            var f = /^https?\:\/\/(pan|yun)\.baidu\.com\/(s\/[A-Za-z0-9]{6,16}|share\/.*uk\=\d{6,12}.*)(\#.*)?$/;
            var j = {};
    ...
    var b = {
        adExist: {
            adtxt: function(e) {
                ...
                var f = a.whatPage(e);
                txtElem.href = f.url || txtElem.href;
                txtElem.innerHTML = f.txt || txtElem.innerHTML
            },
            adimg: function(e) {
                ...
                imgElem.style.cssText = "background:url(%src%) center center no-repeat; display:block;".replace(/%src%/, e.src);
                imgElem.href = e.url
            }
        },
        adNotUse: {
            adtxt: function(f) {
                ...
                var e = document.getElementById("departForAd");
                e && (e.style.display = "none")
            }
        }
    };
    var c = function() {
        var h = document.getElementById("top_menu_other"),
        e = document.getElementById("share_aside"),
        f = +!!e + "";
        f = f + ( + !!h);
        f = parseInt(f, 2);
        var g = g || {};
        g.api = g.api || {};
        g.api.RestAPI = g.api.RestAPI || {};
        g.api.RestAPI.CMS_DATA_SIMPLE = g.api.RestAPI.CMS_DATA_SIMPLE || "/disk/cmsdata";
        $.get(g.api.RestAPI.CMS_DATA_SIMPLE + "?do=piece&ad=" + f + "&t=" + ( + new Date()), {},
        function(m) {
            var o, l, k;
            try {
                o = $.parseJSON(m)
            ...
            if (o != null && o.errorno == 0) {
                for (var j in o.content) {
                    if ( !! +o.content[j].used) {
                        b.adExist[j] && b.adExist[j](o.content[j])
                    } else {
                        b.adNotUse[j] && b.adNotUse[j](o.content[j])
                    }
                }
            }
        });
        h.onclick = function() {
            ...
            window.FileUtils && FileUtils._mDiskLog.send(i); ! window.FileUtils && a.imgLog("http://pan.baidu.com/api/analytics", i)
        };
        d()
    };
    var d = function() {
        var e = $(".img-content").children();
        var f = f || {};
        f.api = f.api || {};
        f.api.RestAPI = f.api.RestAPI || {};
        f.api.RestAPI.CMS_DATA_SIMPLE = f.api.RestAPI.CMS_DATA_SIMPLE || "/disk/cmsdata";
        $.get(f.api.RestAPI.CMS_DATA_SIMPLE + "?do=manual&ch=pan_focuspic&t=" + ( + new Date()), {},
        function(h) {
            var k;
            try {
                k = $.parseJSON(h)
            } catch(j) {}
            if (k != null && k.errorno == 0) {
                for (var g in k.content) {
                    if ($(".img-content").children().length && k.content[g].imgid === "focus" && !!+k.content[g].used) {
                        e[g].children[0].src = k.content[g].src
                    } else {
                        if (k.content[g].imgid === "logo" && !!+k.content[g].used) {
                            $(".yun-logo").css("background", "url('" + k.content[g].src + "')")
                        }
                    }
                }
            }
