...
//<!--页面加载完执行-->
	$(function(){
		...
		{
			title = "个人用户统计信息";
			url = "/commonUser/CommonUserOnlineData.jsp";
		}			
...
<div data-options="region:'west',split:true,title:'管理菜单'" style="width:185px; overflow:auto;">
  <ul class="easyui-tree" id="tree">
    ...
    <li iconCls="icon-ytj-jk"> <span>个人用户信息统计</span>
      <ul>
        <!-- <li iconCls="icon-light"><span><a url="/commonUser/CommonUserOnlineData.jsp"  iconCls="icon-light">个人用户信息统计</a></span></li> -->
        <li iconCls="icon-light"><span><a url="/commonUser/example.jsp"  iconCls="icon-light">个人用户信息</a></span></li>
<!--        <li iconCls="icon-map"><span><a url="areaManage.jsp" iconCls="icon-map">地域管理</a></span></li>-->
<!--        <li iconCls="icon-shebei"><span><a url="deviceManage.jsp" iconCls="icon-shebei">设备管理</a></span></li>-->
      </ul>
    </li>
  
<!--    <li iconCls="icon-user"> <span>账号管理</span>-->
<!--      <ul>-->
<!--        <li iconCls="icon-user_error"><span><a url="warningAccountManage.jsp" iconCls="icon-user_error">预警账号管理</a></span></li>-->
<!--        <li iconCls="icon-audit"><span><a url="auditAccountManage.jsp" iconCls="icon-audit">审计账号管理</a></span></li>-->
<!--        <li iconCls="icon-netSave"><span><a url="securityAccountManage.jsp" iconCls="icon-netSave">网络安全管理</a></span></li>-->
<!--        <li iconCls="icon-user_admin"><span><a url="operationAccountManage.jsp" iconCls="icon-user_admin">运维账号管理</a></span></li> -->
<!--       </ul>-->
<!--      </li>-->
<!--        <li iconCls="icon-maintenance"> <span>运维</span>-->
<!--          <ul>-->
<!--            <li iconCls="icon-Company2"><span><a url="companyManage.jsp" iconCls="icon-Company2">厂商管理</a></span></li>			-->
<!--			<li iconCls="icon-ywzy"><a url="returnCitiesList_1Account.action" iconCls="icon-ywzy">运维资源</a></li>           -->
<!--          </ul>-->
<!--        </li>-->
<!--         -->
<!--    <li iconCls="icon-tjm"> <span>上传特征库</span>-->
<!--	  <ul>-->
<!--		<li iconCls="icon-tjmk"><span><A style="CURSOR: pointer" url="enterUploadPage.action" iconCls="icon-tjmk">特征码库</A></span></li>-->
<!--	  </ul>-->
<!--	</li>  -->
<!--	-->
...
<!--	<li iconCls="icon-data"> <span>数据库备份</span>-->
<!--	  <ul>-->
<!--		<li iconCls="icon-cybf"><span><a url="dbDiffBackup.jsp" iconCls="icon-cybf">差异备份</a></span></li>-->
<!--		<li iconCls="icon-wzbf"><span><a url="dbFullBackup.jsp" iconCls="icon-wzbf">完整备份</a></span></li>            -->
<!--	  </ul>-->
<!--	</li>-->
<!--    <li iconCls="icon-fixPwd"><span><a url="changePWD.jsp" iconCls="icon-fixPwd">修改密码</a></span></li>    -->
  </ul>
</div>
